...
export default function WrappedStep({
  ...
  return (
    <div className="w-full h-full mx-auto relative overflow-hidden">
      ...
      <div
        className={`absolute top-0 left-0 w-full h-full z-20 flex flex-col items-center justify-center px-4 text-center ${
      ...
      >
        {currentStep === 0 && (
          <>
            ...
            <p className="mt-4">지난 한 달간 <span className="font-semibold">{artistName} 덕후</span> 님의 활동 기록입니다.</p>
        ...
        {currentStep === 2 && (
          <>
            ...
            <p>당신의 시선과 마음이 담긴 감상 하나하나가 모여, 멋진 색으로 완성되었어요.</p>
          </>
        )}
        ...
        {currentStep === 4 && recommendedImg && recommendedImg.length >= 2 && recommendedArtwork && recommendedArtist && (
          <>
