...
(1, 'ImpressionSunrise_Monet', '붓 터치가 부드럽고 따뜻해.', true, '2025-03-06', 6),
(1, 'WaterLilies_Monet', '자연의 평온함이 느껴졌다.', false, '2025-03-07', 2),
(1, 'Guernica_Picasso', '전쟁의 참혹함이 와닿았다.', true, '2025-03-08', 7),
(1, 'StarryNight_VanGogh', '밤하늘의 소용돌이가 강렬해.', true, '2025-03-09', 10),
(1, 'CampbellSoup_Warhol', '재미있는 상업미술의 시도.', false, '2025-03-10', 1),
(1, 'Marilyn_Warhol', '반복된 마릴린 얼굴이 강렬했다.', true, '2025-03-11', 2),
(1, 'HowToExplain_Beuys', '다소 난해했지만 흥미로웠다.', false, '2025-03-12', 0),
(1, 'MonaLisa_Leonardo', '실제로 보면 작다고 들었다.', true, '2025-03-13', 4),
(1, 'TheLastSupper_Leonardo', '인물 간의 감정선이 살아있다.', true, '2025-03-14', 3),
(1, 'David_Michelangelo', '근육 표현이 너무 정교해.', false, '2025-03-15', 5),
(1, 'Judith_Caravaggio', '잔혹하지만 아름답다.', true, '2025-03-16', 2),
(1, 'ImpressionSunrise_Monet', '햇살이 비치는 느낌이 좋다.', false, '2025-03-17', 3),
(1, 'WaterLilies_Monet', '연못의 고요함이 좋았다.', true, '2025-03-18', 6),
(1, 'Guernica_Picasso', '흑백이 더 충격적이었다.', true, '2025-03-19', 8),
(1, 'StarryNight_VanGogh', '내가 가장 좋아하는 작품!', false, '2025-03-20', 10),
(1, 'CampbellSoup_Warhol', '팝아트의 시작이라는데 놀랍다.', true, '2025-03-21', 1),
(1, 'Marilyn_Warhol', '반복 속 의미가 뭘까 고민됐다.', false, '2025-03-22', 0),
(1, 'HowToExplain_Beuys', '예술이란 무엇일까 생각하게 함.', true, '2025-03-23', 2),
(1, 'MonaLisa_Leonardo', '모나리자의 눈빛이 잊혀지지 않는다.', false, '2025-03-24', 4),
(1, 'TheCalling_Caravaggio', '빛 표현이 마치 스포트라이트 같았다.', true, '2025-03-25', 3),
(1, 'ImpressionSunrise_Monet', '색감이 정말 부드럽다.', true, '2025-03-26', 5),
(1, 'Guernica_Picasso', '보는 내내 불편하고 힘들었다.', false, '2025-03-27', 9),
